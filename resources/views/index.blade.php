...
<body class="bg-slate-950 text-white">
    ...
    <section class="pt-32 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-slate-950 to-pink-900/20"></div>
        <div class="max-w-7xl mx-auto relative z-10">
            <div class="text-center max-w-4xl mx-auto">
                <h1 class="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 gradient-animate bg-clip-text text-transparent">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="/login" class="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-lg font-semibold hover:shadow-2xl hover:shadow-purple-500/50 transition transform hover:scale-105">
                        Start Learning Free
                    </a>
                ...
                <div class="mt-16 relative">
                    <div class="animate-float inline-block">
                        <div class="bg-gradient-to-br from-purple-500/10 to-pink-500/10 backdrop-blur-xl rounded-2xl border border-purple-500/20 p-8 shadow-2xl shadow-purple-500/20 max-w-md">
    ...
    <section id="features" class="py-20 px-4 sm:px-6 lg:px-8 bg-slate-900/50">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="card-hover bg-gradient-to-br from-purple-500/10 to-slate-800 p-8 rounded-2xl border border-purple-500/20">
                    <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl flex items-center justify-center text-2xl mb-4">🤖</div>
                ...
                <div class="card-hover bg-gradient-to-br from-pink-500/10 to-slate-800 p-8 rounded-2xl border border-pink-500/20">
                    <div class="w-12 h-12 bg-gradient-to-br from-pink-500 to-purple-500 rounded-xl flex items-center justify-center text-2xl mb-4">🎯</div>
                ...
                <div class="card-hover bg-gradient-to-br from-blue-500/10 to-slate-800 p-8 rounded-2xl border border-blue-500/20">
                    <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-xl flex items-center justify-center text-2xl mb-4">📊</div>
                ...
                <div class="card-hover bg-gradient-to-br from-green-500/10 to-slate-800 p-8 rounded-2xl border border-green-500/20">
                    <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-blue-500 rounded-xl flex items-center justify-center text-2xl mb-4">🌐</div>
                ...
                <div class="card-hover bg-gradient-to-br from-yellow-500/10 to-slate-800 p-8 rounded-2xl border border-yellow-500/20">
                    <div class="w-12 h-12 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-xl flex items-center justify-center text-2xl mb-4">👥</div>
                ...
                <div class="card-hover bg-gradient-to-br from-orange-500/10 to-slate-800 p-8 rounded-2xl border border-orange-500/20">
                    <div class="w-12 h-12 bg-gradient-to-br from-orange-500 to-red-500 rounded-xl flex items-center justify-center text-2xl mb-4">📱</div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-12">
                <div class="text-center">
                    <div class="w-20 h-20 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6">1</div>
                ...
                <div class="text-center">
                    <div class="w-20 h-20 bg-gradient-to-br from-pink-500 to-purple-500 rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6">2</div>
                ...
                <div class="text-center">
                    <div class="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6">3</div>
    ...
    <section class="py-20 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <button class="px-10 py-4 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl text-lg font-semibold hover:shadow-2xl hover:shadow-purple-500/50 transition transform hover:scale-105">

    ...
    <div class="w-full max-w-3xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            @foreach ($quizzes as $quiz)
                <div class="bg-zinc-800/50 justify-center items-center flex flex-col backdrop-blur-sm rounded-2xl border border-zinc-700/50 p-6 hover:border-zinc-600/50 transition-all duration-200">
                    <div class="flex flex-col items-center justify-between space-y-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <a href="{{ route('quiz.start', $quiz->id) }}" class="text-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-200">
                                Start Quiz
                            </a>
                            <a href="{{ route('quiz.review', $quiz->id) }}" class="text-center px-4 py-2 bg-zinc-700 hover:bg-zinc-600 text-white font-semibold rounded-lg transition-all duration-200">
                                Review Questions
                            </a>
                        </div>
                    </div>
            ...
            <div class="bg-zinc-800/50 justify-center items-center flex flex-col  backdrop-blur-sm rounded-2xl border border-zinc-700/50 p-6 hover:border-zinc-600/50 transition-all duration-200">
                    <div class="flex flex-col items-center justify-between space-y-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <a href="/generate-flashcards" class="text-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-all duration-200">
                                Add quiz
                            </a>
                        </div>
                    </div>
